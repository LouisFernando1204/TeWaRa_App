...
public struct TabViewRouterMac: View {
        ...
        TabViewRouterMac(
            ...
            content: [
                (
                    ...
                    view: AnyView(HomeViewMac().navigationBarBackButtonHidden(true))
                ),
                (
                    tabText: "Peringkat",
                    tabIconName: "chart.bar.fill",
                    view: AnyView(LeaderboardViewMac().navigationBarBackButtonHidden(true))
                )
            ]
        )
